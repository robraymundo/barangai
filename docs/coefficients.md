...
| Nominal zone area | **500,000 m² (~0.5 km²)** | Low | Placeholder matching the demo grid cells in `data/barangay.geojson`. Replace per-zone once real **PSA/OSM** boundary polygons are loaded. |
